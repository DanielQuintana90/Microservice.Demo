...
namespace Microservices.Demo.Policy.API.CQRS.Commands.CreateOffer
{
    public class CreateOfferHandler : IRequestHandler<CreateOfferCommand, CreateOfferResult>
    {
        ...
        public CreateOfferHandler(IUnitOfWork unitOfWork, IPricingAgent<Price, Answer> pricingAgent,OfferDomainService offerDomainService)
        {
        ...
        public async Task<CreateOfferResult> Handle(CreateOfferCommand request, CancellationToken cancellationToken)
        {
            ...
            var offer = OfferDomainService.CreateOfferForPrice(
